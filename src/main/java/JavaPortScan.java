...
// Write to Redis only if the port is open
                        System.out.println("Writing to Redis: Port " + port + " - " + portMap.get(port));
                        ...
                        System.out.println("Successfully wrote to Redis.");

                        System.out.println("Reading from Redis: Port " + port + " - " + portMap.get(port));
                        jedis.hget("open_ports", String.valueOf(port));
                        jedis.hget("open_ports_description", String.valueOf(port));
                    } catch (IOException e) {
